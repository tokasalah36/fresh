                ...
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                                    ...
                                    {wishListProduct.map((product) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <button onClick={() => { deleteProduct(product._id); }} className="font-bold text-red-800 dark:text-red-500 hover:underline">
                                                   REMOVE
                                                </button>
                                            </td>
                            ...
                            ) : <h2 className='text-green-700 py-6 text-center text-3xl'>WishList Is Empty</h2>}
                        </tbody>
